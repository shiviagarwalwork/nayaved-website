...
export default function QuickStart() {
  ...
  return (
    <div className="relative bg-gradient-to-br from-white via-[var(--parchment-light)] to-[var(--parchment)] rounded-xl shadow-lg p-6 border-2 border-[var(--palm-leaf)]">
      ...
      {/* App Download CTA */}
      <div className="mt-10 bg-gradient-to-br from-[var(--copper-brown)] to-[var(--henna)] rounded-2xl p-6 text-center relative overflow-hidden">
        {/* Corner decorations */}
        <div className="absolute top-3 left-3 text-white/30 text-xl">❧</div>
        <div className="absolute top-3 right-3 text-white/30 text-xl transform scale-x-[-1]">❧</div>

        <Sparkles className="w-10 h-10 text-[var(--gold-leaf)] mx-auto mb-3" />
        ...
        <p className="text-white/80 mb-4 max-w-md mx-auto">
          Download the NayaVed AI app for tongue, eye, and skin analysis - AI-powered diagnostics based on ancient Pariksha methods.
        </p>
        <div className="flex flex-wrap justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 bg-white text-[var(--copper-brown)] px-5 py-2.5 rounded-xl font-bold text-sm hover:bg-gray-100 transition-colors"
          >
